...
5. 观众可见文字仅使用简体中文。标题位于顶部安全区，来源固定左下角。禁止出现制作、页面、动画、工作流、提示词等幕后文案。避免使用“不是……而是……”句式。
